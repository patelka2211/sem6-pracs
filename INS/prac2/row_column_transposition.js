"use strict";
function cleanPlaintext(pt) {
    return pt.split(" ").join("").toUpperCase();
}
function encryption(pt, encryptionKey) {
    ...
    if (cols <= 1)
        throw Error("Key must be of at least 2 digit.");
...
function decrypt(ct, encryptionKey) {
...
const pt = "Information and Network Security", encryptionKey = 35142;
